...
;Links
    ...
    !define LINK_AJNETMASK "https://github.com/applejuicenetz/ajnetmask/releases/latest/download/ajnetmask-i386.dll"
    !define LINK_TRAYICON "https://github.com/applejuicenetz/core-trayicon/releases/latest/download/TrayIcon12_x86.dll"

    !define LINK_JRE_7 "https://github.com/applejuicenetz/zulu-jre7/releases/latest/download/jre7.x86.zip"
...
Section ""
    ...
    INetC::get /NOCANCEL "${LINK_CORE}" "ajcore.jar" /END
    Pop $0
    DetailPrint $0

    DetailPrint "download ajnetmask.dll"
    INetC::get /NOCANCEL "${LINK_AJNETMASK}" "ajnetmask.dll" /END
    Pop $0
    DetailPrint $0

    DetailPrint "download TrayIcon12.dll"
    INetC::get /NOCANCEL "${LINK_TRAYICON}" "TrayIcon12.dll" /END
    Pop $0
    DetailPrint $0

    ${IfNot} ${FileExists} "Java\*.*"
